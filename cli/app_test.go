...
func TestNewApp(t *testing.T) {
	...
	assert.Equal("validate", app.Commands[5].Name, "Command[5].name should match")
	assert.Equal("purge", app.Commands[6].Name, "Command[6].name should match")
	assert.Equal("batch", app.Commands[7].Name, "Command[7].name should match")
}
